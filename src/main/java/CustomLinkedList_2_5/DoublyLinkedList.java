...
public class DoublyLinkedList implements InterfaceList, Iterable<Integer> {
    ...
    public void forEachBackward(Consumer<Integer> action) {
        Node current = tail;
        while (current != null) {
            action.accept(current.data);
    ...
    public void forEachFromHeadToTarget(Consumer<Integer> action, int target) {
        Node current = head;
        boolean found = false;
        while (current != null) {
            action.accept(current.data);
    ...
    public void forEachFromTailToTarget(Consumer<Integer> action, int target) {
        Node current = tail;
        boolean found = false;
        while (current != null) {
            action.accept(current.data);
